...
class PWAManager {
    ...
    checkInstallStatus() {
        // 检查是否在独立模式下运行（已安装）
        this.isInstalled.value = window.matchMedia('(display-mode: standalone)').matches ||
      ...
      `,
        ...
        setTimeout(() => {
            ...
            if (installBtn) {
                installBtn.onclick = () => {
                    this.installApp();
                    document.querySelector('.install-prompt .el-notification__closeBtn').click();
                };
            }
      ...
      `
        ...
        setTimeout(() => {
            ...
            if (updateBtn) {
                updateBtn.onclick = () => {
                    this.applyUpdate();
                    document.querySelector('.update-prompt .el-notification__closeBtn').click();
                };
            }
