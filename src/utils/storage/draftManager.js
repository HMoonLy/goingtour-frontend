    ...
    async getDraft(draftId) {
        ...
        try {
            ...
            console.log("🔍 草稿数据详细分析:", {
                ...
                baseFormKeys: draft.baseForm || draft.base_form ?
                ...
                preferenceFormKeys: draft.preferenceForm || draft.preference_form ?
                ...
                attractionsCount: draft.selectedAttractions || draft.selected_attractions ?
                    (draft.selectedAttractions || draft.selected_attractions).length :
                    0,
                hasRestaurants: !!(
                    draft.selectedRestaurants || draft.selected_restaurants
                ),
                restaurantsCount: draft.selectedRestaurants || draft.selected_restaurants ?
