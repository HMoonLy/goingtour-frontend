...
>
        ...
        <div class="filter-tabs">
          <el-radio-group
v-model="activeFilter" size="small"
>
        ...
        <div class="trips-container">
          <div
v-if="loading" class="loading-state"
>
            <el-skeleton
:rows="3" animated
/>
          ...
          <div
v-else-if="filteredTrips.length === 0" class="empty-state"
>
            <el-empty
:description="getEmptyDescription()" :image-size="120"
>
              <template #image>
                <el-icon
size="80" color="#d3d3d3"
>
                  <DocumentCopy />
                </el-icon>
              </template>
...
>
              ...
              <div class="trip-meta">
                ...
                <div
v-if="trip.totalBudget" class="meta-item"
>
...
v-else type="success" size="small"> 已完成 </el-tag>
      ...
      <section class="quick-actions">
        ...
        <div class="actions-grid">
          <div
class="action-card" @click="$router.push('/destinations')"
>
            <el-icon><MapLocation /></el-icon>
...
>
          ...
          <div
class="action-card" @click="exportTrips"
>
          ...
          <div
class="action-card" @click="$router.push('/personal/settings')"
>
