...
:class="{ embedded }">
    ...
    <h2
v-if="!embedded" class="title">安全设置</h2>
    ...
    <el-card class="section">
      <div class="row">
        ...
        <el-button
type="primary" plain @click="openSet"> 设置密码 </el-button>
      </div>
      <div class="row">
        <div>
        ...
        <el-button
type="primary" @click="openChange"> 修改密码 </el-button>
      </div>
      <div class="row">
        <div>
        ...
        <el-button
type="danger" plain @click="clearPwd"> 清除密码 </el-button>
      </div>
    </el-card>
