<template>
    ...
    <div class="profile-sections">
      <el-card class="section-card">
        ...
        <div class="row">
          ...
          <span class="value">{{ userStore.currentUser?.phone || "未绑定" }}</span>
        </div>
        <div class="row">
  ...
  <el-drawer v-model="showSecurity" title="安全设置" size="60%" destroy-on-close>
    <Security embedded />
  </el-drawer>

  <el-drawer v-model="showNotifications" title="通知设置" size="60%" destroy-on-close>
