  ...
  <div class="trip-create-container">
    ...
    <div class="step-container">
      ...
      <TripPreferences 
        ...
        v-model:preferenceForm="preferenceForm"
        :baseForm="baseForm"
        :selectedAttractions="selectedAttractions"
        :selectedRestaurants="selectedRestaurants"
        @update:selectedAttractions="selectedAttractions = $event"
        @update:selectedRestaurants="selectedRestaurants = $event"
        @next-step="nextStep"
        @prev-step="prevStep"
      />
      ...
      <TripGeneration 
        ...
        @update:extraRequirements="extraRequirements = $event"
