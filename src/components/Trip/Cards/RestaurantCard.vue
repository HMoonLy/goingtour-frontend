  ...
  <div class="restaurant-card" :class="{ selected: isSelected }">
    ...
    <div class="card-header">
      ...
      <div class="type-section">
        <el-tag type="warning" size="small">餐厅</el-tag>
        <el-tag v-if="restaurant.cuisine || restaurant.type" type="info" size="small">
...
const getImageUrl = () => {
  ...
  // 使用在线占位符图片
  return 'https://via.placeholder.com/160x160/E67E22/FFFFFF?text=餐厅'
}
